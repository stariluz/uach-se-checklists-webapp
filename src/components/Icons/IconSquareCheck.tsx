...
const IconSquareCheck = (props: IIconProps) => {
    return (
        <BaseIcon className={props.boxClassName}>
            {/* <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`${props.className} icon icon-tabler icons-tabler-outline icon-tabler-square-check`}>
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                <path d="M3 3m0 2a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v14a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2z" />
                <path d="M9 12l2 2l4 -4" />
            </svg> */}
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`${props.className} icon icon-tabler icons-tabler-outline icon-tabler-square-check`}>
                <g clip-path="url(#clip0_110_2113)">
                    ...
                    <path d="M8 11.6862L10.6667 14.1862L16 9.18616" stroke="auto" />
                </g>
                <defs>
